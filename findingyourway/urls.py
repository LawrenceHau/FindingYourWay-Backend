...
from .views import AdventureList, PathList, RouteList, EndingList
...
urlpatterns = [
    ...
    path("api/adventures/", AdventureList.as_view()),
    path("api/paths/", PathList.as_view()),
    path("api/route/", RouteList.as_view()),
    path("api/ending/", EndingList.as_view())
    ]